...
public class HostNameUtils {
    ...
    /**
     * Returns the hostname or IP address of {@link InetSocketAddress}.
     *
     * This method returns the IP address if the
     * {@link InetSocketAddress} was created with a literal IP address,
     * and it doesn't perform a reverse DNS lookup. The goal of this method is
     * to substitute {@link InetSocketAddress#getHostString()}, which
     ...
     * {@link InetAddress}. It returns a string with the form
     * "hostname/literal IP address", and the hostname part is empty if the
     * input {@link InetSocketAddress} was created with an IP address.
     * There are 2 implementations of {@link InetAddress},
     ...
     * method.
     *
     * @return the hostname or IP address of {@link InetSocketAddress}.
