...
public class JBuffer extends JCompType {
    ...
    public String genJavaCompareTo(String fname, String other) {
      ...
      sb.append("      ret = org.org.apache.jute.Utils.compareBytes(my,0,my.length,ur,0,ur.length);\n");
      sb.append("    }\n");
      return sb.toString();
    }
    ...
    public String genJavaEquals(String fname, String peer) {
        return "    ret = org.org.apache.jute.Utils.bufEquals("+fname+","+peer+");\n";
    }
    ...
    public String genJavaSlurpBytes(String b, String s, String l) {
      StringBuilder sb = new StringBuilder();
      sb.append("        {\n");
      sb.append("           int i = org.org.apache.jute.Utils.readVInt("+b+", "+s+");\n");
    ...
    public String genJavaCompareBytes() {
      StringBuilder sb = new StringBuilder();
      sb.append("        {\n");
      sb.append("           int i1 = org.org.apache.jute.Utils.readVInt(b1, s1);\n");
      sb.append("           int i2 = org.org.apache.jute.Utils.readVInt(b2, s2);\n");
      ...
      sb.append("           int r1 = org.org.apache.jute.Utils.compareBytes(b1,s1,l1,b2,s2,l2);\n");
